...
def test_sse():
    dummy_predictions = np.array([5.0, 6.0, 7.0, 8.0])
    dummy_labels = np.array([3.0, 4.0, 5.0, 6.0])
    dummy_sse = 3.0
...
def test_rmse():
    dummy_predictions = np.array([2.0, 3.0, 4.0, 5.0])
    dummy_labels = np.array([4.0, 5.0, 6.0, 7.0])
    dummy_rmse = 1.0
